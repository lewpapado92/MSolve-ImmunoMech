...
namespace ISAAR.MSolve.Analyzers.Dynamic
{
    public class NewmarkDynamicAnalyzer : INonLinearParentAnalyzer //TODO: why is this non linear
    {
        ...
        public void SolveTimestep(int i)
        {
            ...
            using (var fileName = new StreamWriter(@"C:\Users\cluster\Desktop\MSolve-ImmunoMech\MSolve-ImmunoMech\ISAAR.MSolve.Tests\Results\MSolveHyperelasticDynamicsImplicitResults.txt", true))
            {
